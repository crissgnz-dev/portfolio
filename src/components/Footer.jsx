    ...
    <footer className="py-20 bg-dark-bg border-t border-dark-border">
      <div className="container mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-8 sm:gap-16">
            <div className="space-y-4">
              ...
              <nav className="flex flex-col gap-3">
                <a href="https://www.linkedin.com/in/gonzalezcristian-dev/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-zinc-400 hover:text-white transition-colors group">
                  LinkedIn <ArrowUpRight size={14} className="group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
                </a>
                <a href="https://github.com/crissgnz-dev" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-zinc-400 hover:text-white transition-colors group">
        ...
        <div className="mt-20 pt-8 border-t border-zinc-900 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-zinc-600 font-medium">
          <p>© {new Date().getFullYear()} Gonzalez Cristian - Desarrollador Fullstack</p>
